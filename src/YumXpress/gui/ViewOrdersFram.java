 ...
 */
public class ViewOrdersFram extends javax.swing.JFrame {
  private DefaultTableModel model;
  private List<OrderForStaffPojo> orderList;
    /**
     * Creates new form ViewOrdersFram
     */
    public ViewOrdersFram()   {
        initComponents();
         setLocationRelativeTo(null);
         setTitle("View Orders Page");
    ...
    private void btnBackActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBackActionPerformed
      ...
      DeliveryStaffFrame dsf=new DeliveryStaffFrame();
        dsf.setVisible(true);
        this.dispose();
    ...
    private void jtOrderListMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jtOrderListMouseClicked
        // TODO add your handling code here:
         ...
         OrderForStaffPojo orderp=orderList.get(index);
         int actualOtp=orderp.getOtp();
         while(true)
         {
         String strOpt= JOptionPane.showInputDialog(null,"Plese fill the OTP");
         if(strOpt==null)
         {
             return;
         }
        try {
            {
                 int UserOtp=Integer.parseInt(strOpt);
         if(UserOtp==actualOtp)
          {
          boolean result=  OrderDAO.confornOrder(orderp.getOrderId());
            if(result)
             {
            ...
            JOptionPane.showMessageDialog(null, "Order can not be confirnmed");
          }
         else{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewOrdersFram.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewOrdersFram().setVisible(true);
            }
        });
    }
    ...
    //      <===================THIS METHOD  LOAD NEW ORDER DETAILS===================>
    ...
    private void loadNewOrderDetails(String StaffId) {
        try{
            ...
            if(orderList.isEmpty())
            {
                JOptionPane.showMessageDialog(null,"No Undeliverd Order!");
            ...
            {
                OrderForStaffPojo ord=orderList.get(i);
